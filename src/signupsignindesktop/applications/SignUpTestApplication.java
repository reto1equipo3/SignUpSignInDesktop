...
import signupsignindesktop.ui.controllers.SignUpDesktopFxmlController;
 ...
 * @author Imanol
 */
public class SignUpTestApplication extends javafx.application.Application {
	...
	public void start(Stage stage) throws Exception {
		...
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/signupsignindesktop/ui/fxml/SignUpDesktopFXMLDocument.fxml"));

		Parent root = (Parent) loader.load();

		//Get controller for graph 
		SignUpDesktopFxmlController controller = ((SignUpDesktopFxmlController) loader.getController());
